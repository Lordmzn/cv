...
\ecvitem{\textbf{\nth{4} Aug 2021 - present}}{\large Digital solutions manager}
\ecvitem{Main tasks and responsibilities}{I own the technical direction of EMS, ENERSEM's cloud platform for energy monitoring and optimization, which drives more than a third of company revenue. EMS collects time-series data from 30+ industrial and commercial sites across 15+ clients, with continuous storage since 2020. I designed and built the core time-series analysis library — over 30 composable analysis functions with a no-code interface — and the remote setpoint optimization system running on plants worth 50k€+. Since 2021 I have been coordinating 1.5 FTE of external developers; for the past year and a half I have also been leading two internal colleagues. I supervise funded research projects and contribute to grant writing.}
\ecvitem[10pt]{Name and address of employer}{ENERSEM s.r.l.}

\ecvitem{\textbf{\nth{9} Jul 2020 - \nth{3} Aug 2021}}{\large Socio lavoratore}
\ecvitem{Main tasks and responsibilities}{Formal entry into ENERSEM as an equity partner. Took ownership of EMS development, transitioning from external research consultant to internal platform builder responsible for the product's technical direction.}
\ecvitem[10pt]{Name and address of employer}{ENERSEM s.r.l.}

\ecvitem{\textbf{\nth{6} Mar 2018 - \nth{8} Jul 2020}}{\large Consultant for ENERSEM}
\ecvitem{Main tasks and responsibilities}{Developed energy models for industrial plants, offices and commercial buildings, combining data analysis, machine learning and model predictive control to extract insights on energy use and efficiency. Led the technical work on two funded research projects: TEPORE (2018--2019), developing an MPC algorithm for smart thermostats and occupancy-based control; and LombHe@t (2020--), integrating heat pump modelling into control algorithms and analysing district heating consumption profiles.}
\ecvitem[10pt]{Name and address of employer}{ENERSEM s.r.l.}
...
\ecvitem{Data/ML}{Jupyter notebooks in Python with pandas, sklearn and statsmodels}
\ecvitem{Scientific computing}{Matlab, R}
\ecvitem{Systems/infra}{Bash, C++, Elixir, Java, Git}
